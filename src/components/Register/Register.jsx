...
import RegisterArtCraft from "../../assets/registration.jpg";
...
const Register = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Registration | Art and Craft</title>
      </Helmet>
      <div className="p-4">
          ...
          <div className="bg-slate-400 rounded-2xl flex max-w-3xl lg:w-[768px] p-5 items-center">
            ...
            <div className="md:block hidden w-1/2">
              ...
              <img
                ...
                src={RegisterArtCraft}
                onLoad={handleImageLoad} // Set loading to false when the image is loaded
                alt="Login ArtCraft" // Add alt attribute for accessibility
              />
            </div>
          </div>
        </section>
